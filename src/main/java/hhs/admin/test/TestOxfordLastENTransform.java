...
/**
 * Test the *real* {@link OxfordLastNameEnParser} by running it against the *real* data file.
 * 
 * @author wjohnson000
 *
 */
public class TestOxfordLastENTransform {

    public static void main(String...args) {
        NameParser parser = new OxfordLastNameEnParser();

        try {
            byte[] contents = Files.readAllBytes(Paths.get("C:/D-drive/homelands/names/final/last_acref_9780195081374.xml"));
            ...
            Files.write(Paths.get("C:/temp/oxford-last-out.csv"), canonicalData, StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING);
        } catch(Exception ex) {
